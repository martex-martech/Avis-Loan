...
SECRET_KEY = 'django-insecure-1880%b^nhacul!j(tt*dl!87nm&a2tgn!_@iwc!%6j-(wkzlrw'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        'rest_framework.authentication.SessionAuthentication', # Optional, kept for browsable API
...
SIMPLE_JWT = {
    ...
    # Cookie settings (for future use)
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'berzzgame@gmail.com'
EMAIL_HOST_PASSWORD = 'axei ixdh ylyw olme'
DEFAULT_FROM_EMAIL = 'Avis4u@gmail.com'
...
# Place all your static files here (same level as manage.py)
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
